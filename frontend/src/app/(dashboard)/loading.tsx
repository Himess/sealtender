  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="h-4 w-72 bg-[#1A1D27] rounded animate-pulse" />
      </div>
      ...
      <div className="bg-[#0F1117] border border-[#1A1D27] rounded-xl p-5 space-y-4">
        <div className="h-5 w-36 bg-[#1A1D27] rounded animate-pulse" />
        {[...Array(5)].map((_, i) => (
          <div key={i} className="flex gap-4">
            <div className="h-4 w-12 bg-[#1A1D27] rounded animate-pulse" />
